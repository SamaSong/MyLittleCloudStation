...
import {
  arrayBufferExample,
  textDecoderConstructorExample,
  textDecoderDecodeExample,
  textDecoderExample,
  textEncoderConstructorExample,
  textEncoderExample,
  blobConstructorExample,
  blobCreateExample,
  blobSliceExample,
  blobDownloadLinkExample,
  blobAutoDownloadExample,
  imageToBlobExample,
  canvasToBlobAsyncExample,
  blobToArrayBufferExample,
  fileConstructorExample,
  fileInputExample,
  fileReaderConstructorExample,
} from './basicApi.examples.js'
</script>
...
<template>
  ...
  >
    <div data-custom="ArrayBuffer，二进制数组">
      ...
      <CodeBlock :code="arrayBufferExample" />
      <span class="content">
    ...
    <div data-custom="TextDecoder 和 TextEncoder">
      ...
      <CodeBlock :code="textDecoderConstructorExample" />
      <ul>
      ...
      <CodeBlock :code="textDecoderDecodeExample" />
      <ul>
      ...
      <span>例如</span>
      <CodeBlock :code="textDecoderExample" />
      <h3>TextEncoder</h3>
      <span class="content"><span class="bgc">TextEncoder</span> 做相反的事情 —— 将字符串转换为字节。
        <br>
        语法为：
      </span>
      <CodeBlock :code="textEncoderConstructorExample" />
    ...
    <div data-custom="Blob">
      ...
      <span>例如</span>
      <CodeBlock :code="blobCreateExample" />
      <span class="content">我们可以用 slice 方法来提取 Blob 片段：</span>
      <CodeBlock :code="blobSliceExample" />
      <ul>
      ...
      <CodeBlock language="html" :code="blobDownloadLinkExample" />
      <span class="content">
      ...
      <CodeBlock :code="blobAutoDownloadExample" />
      <span class="content">
      ...
      <CodeBlock :code="imageToBlobExample" />
      <span>如果我们更喜欢 async/await 而不是 callback：</span>
      <CodeBlock :code="canvasToBlobAsyncExample" />
    ...
    <div data-custom="File和FileReader">
      ...
      <CodeBlock language="html" :code="fileInputExample" />
      ...
      <CodeBlock :code="fileReaderConstructorExample" />
      <span>主要方法:</span>
      <ul>
