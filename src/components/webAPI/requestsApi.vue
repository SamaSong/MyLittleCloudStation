...
import {
  ...
  abortFetchExample,
  abortExample,
  abortMultipleJobsExample,
  fetchOptionsExample,
  keepaliveExample,
  urlConstructorExample,
  urlParseExample,
} from './requestsApi.examples.js'
</script>
...
<template>
  ...
  >
    <div data-custom="Fetch">
      ...
      <CodeBlock :code="fetchResponseExample" />
      ...
      <CodeBlock :code="fetchJsonExample" />
      <div class="attention">
    ...
    <div data-custom="Fetch：下载进度">
      ...
      <CodeBlock :code="streamReaderExample" />
    ...
    <div data-custom="Fetch：中止（Abort）">
      ...
      <CodeBlock :code="abortControllerExample" />
    ...
    <div data-custom="Fetch API">
      ...
      <CodeBlock :code="keepaliveExample" />
    ...
    <div data-custom="URL 对象">
      ...
      <CodeBlock :code="urlParseExample" />
      <ul>
        这是 URL 组件的备忘单：
